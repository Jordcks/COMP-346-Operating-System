     ...
     */
     public int findAccount(String accNumber)
     {
         ...
         for (int i=0; i<numberOfAccounts;i++) {
        	 if (account[i].getAccountNumber().equals(accNumber)) {
        		 return i;
        	 }
         }
...
//        		 }
    ...
    {  
    	...
    	if (this.serverThreadId.equals("Thread 1")) {
    	...
    	} else if (this.serverThreadId.equals("Thread 2")) {
    		serverStartTime=System.currentTimeMillis();
        	processTransactions(trans);
    		serverEndTime=System.currentTimeMillis();
    		setServerThreadRunningStatus1("terminated");
		...
		//Disconnecting Server when both threads are terminated
