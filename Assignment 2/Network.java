...
public class Network extends Thread {
    ...
    private static Semaphore transferInFull, receiveFull, transferOutEmpty, sendEmpty, mutex1, mutex2;
     ...
     */
     Network( )
      { 
         ...
         sendEmpty=new Semaphore(maxNbPackets);			//Number of frees slots
         transferOutEmpty=new Semaphore(maxNbPackets);
         
         receiveFull=new Semaphore(0);					//Number of used slots
         transferInFull=new Semaphore(0);
...
//        }   
    ...
    {	
    	...
    	while (!Network.getClientConnectionStatus().equals("disconnected") && !Network.getServerConnectionStatus().equals("disconnected")) {
    		Thread.yield();
    	}
